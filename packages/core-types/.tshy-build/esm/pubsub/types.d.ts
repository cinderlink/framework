...
import { DecodedProtocolMessage, EncodedProtocolPayload, EncodingOptions, ProtocolMessage } from "../protocol";
import { Peer } from "../p2p";
import { PeerId } from "@libp2p/interface";
export type LibP2PPubsubMessage<Events extends PluginEventDef = PluginEventDef, Topic extends keyof Events["subscribe"] = keyof Events["subscribe"], Encoding extends EncodingOptions = EncodingOptions, Data extends EncodedProtocolPayload<Events["subscribe"][Topic], Encoding> = EncodedProtocolPayload<Events["subscribe"][Topic], Encoding>, FromType = PeerId> = {
...
export type SubscribeEvents<PluginEvents extends PluginEventDef = PluginEventDef> = {
    [K in keyof PluginEvents["subscribe"]]: IncomingPubsubMessage<PluginEvents, K>;
};
