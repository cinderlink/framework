...
import type { PluginInterface, PluginEventDef, PluginBaseInterface } from "../plugin/types";
import type { IncomingP2PMessage, OutgoingP2PMessage, PeerRole, PeerStoreInterface, ReceiveEvents } from "../p2p";
...
export interface CinderlinkClientInterface<PluginEvents extends PluginEventDef = {
    ...
    send<Events extends PluginEventDef = PluginEvents, Topic extends keyof Events["send"] = keyof Events["send"], Encoding extends EncodingOptions = EncodingOptions>(peerId: string, message: OutgoingP2PMessage<Events, Topic>, encoding?: Encoding, options?: {
        retries?: number;
        retryDelay?: number;
        offline?: boolean;
    }): Promise<void>;
