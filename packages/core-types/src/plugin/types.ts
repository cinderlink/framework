...
// Default to Record<string, unknown> instead of any for better type safety
export type PluginEventPayloads<T extends Record<string, unknown> = Record<string, unknown>> =
  Record<keyof T, ProtocolPayload<T[keyof T]>>;
  
// Use unknown instead of any for the default handler type
...
// Base event definition with proper defaults
...
export interface PluginInterface<
  ...
  Client extends CinderlinkClientInterface<any> = CinderlinkClientInterface<any>
> extends PluginBaseInterface<Events, Client> {
...
> = new (client: Client, options?: Options) => PluginInterface<Events, PluginEventDef, Client>;
