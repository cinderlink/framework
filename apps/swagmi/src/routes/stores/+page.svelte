...
<Typography classes="text-purple-500 dark-(text-yellow-100)">swagmi/stores</Typography>
<Typography el="p">
...
<section id="wallet">
	...
	<ul>
		...
		<li>
			<Typography el="p">
				<strong>walletMount</strong> - Binds wallet listeners to the @wagmi/core client. Returns an
				unsubscribe function. Typically called in the <strong>onMount</strong> lifecycle hook.
			</Typography>
		</li>
	</ul>
	<Syntax
